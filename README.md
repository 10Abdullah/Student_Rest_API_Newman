# Student_Rest_API_Postman_-_Newman
...
- Run Command:  
```console 
newman run StudentDetailsProject.postman_collection.json -e StudentDetailsProject.postman_collection.json
```
- Run Command for Report: 
```console 
newman run StudentDetailsProject.postman_collection.json -e StudentDetailsProject.postman_collection.json -r cli,htmlextra
```
